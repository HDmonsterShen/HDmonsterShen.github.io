import{_ as c,r as l,o,c as r,a as n,d as e,w as i,b as a,e as t}from"./app-d8a54453.js";const p={},u=n("h1",{id:"python配置手册",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#python配置手册","aria-hidden":"true"},"#"),a(" Python配置手册")],-1),v={class:"table-of-contents"},h=t(`<h2 id="pip" tabindex="-1"><a class="header-anchor" href="#pip" aria-hidden="true">#</a> pip</h2><h3 id="包管理" tabindex="-1"><a class="header-anchor" href="#包管理" aria-hidden="true">#</a> 包管理</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 升级包</span>
